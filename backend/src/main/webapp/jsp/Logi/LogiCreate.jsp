...
<body>
    <div class="container mt-5">
        ...
        <form action="${pageContext.request.contextPath}/LogiCreate" method="post">
            ...
            <div class="mb-3">
                <label for="estimatedArrival" class="form-label">預計到貨時間 (yyyy-MM-dd HH:mm):</label>
            ...
            <div class="mb-3">
                <label for="orderIds" class="form-label">選擇訂單 ID (手動輸入，逗號分隔):</label>
